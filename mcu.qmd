...
as we had a few key timing aspects of this project. 


The GPIO pins fall into two main categories; input and output pins 
...
We ran into many issues with this section as we could never sample the same zero crossing due to the interrupt handler’s run time crowding
