...
We were able to plot the analog signal recevied by the MCU on a local host website using HTML and the cancas API. This plot represents an analog signal over a sweep of frequencies, which will be needed to make the bode plots.
